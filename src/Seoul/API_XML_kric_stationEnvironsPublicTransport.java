...
public class API_XML_kric_stationEnvironsPublicTransport {
    ...
    String url = "http://openapi.kric.go.kr/openapi/convenientInfo/stationEnvironsPublicTransport"; // 서울지하철 - 레일포털 역사 주변 대중교통 이용정보
