...
public class XML_Gwangju_stationINFO {
...
//            File file = new File("C:\\Users\\neiandcompany\\IdeaProjects\\untitled1\\src\\Bus\\Incheon_bus_station_id(duplication";
            File file = new File("C:\\Users\\jiwon\\Desktop\\광주 도시철도 ID.txt");
...
//itemList : http://apis.data.go.kr/6280000/busStationService/getBusStationIdList?serviceKey=Ob7C7H5BU9u4SqoFiGjEJZKZoIPUKQVKqtlEv2HfIxzE5xBzY2qBNZihHiLrnHZfkDWbvgCxpyepaHJoVhdDjQ%3D%3D&pageNo=1&numOfRows=10&bstopId=163000513
            ...
            for (int j = 0; j < busId.length; j++) { // 버스번호 범위
                ...
                while (true) {//http://apis.data.go.kr/6280000/busStationService/getBusStationIdList?serviceKey=%2Feab3wgUxZR46s%2BAthE7A2Aydqs8Uyq6yUXt3XfJQZ55tF%2BdwhlKZ1mjLQOsE%2BEVBhaUhkOUJATDiam35tA6kA%3D%3D&pageNo=1&numOfRows=10&bstopId=101000002
                    ...
                    API_XML_Gwangju_stationINFO apiExplorer_bus = new API_XML_Gwangju_stationINFO();
                    ...
                    NodeList nodeList = doc.getElementsByTagName("row");//itemList
...
/*
                            String txt =
                                            getTagValue("station_id", element) + "|" +
                                            getTagValue("station_name", element) + "|" +
                                            getTagValue("station_place", element) + "|" +
                                            getTagValue("station_area", element) + "|" +
                                            getTagValue("machine_room_area", element) + "|" +
                                            getTagValue("signal_room_area", element) + "|" +
                                            getTagValue("electrical_room_area", element) + "|" +
                                            getTagValue("equipment_room_area", element) + "|" +
                                            getTagValue("waiting_room_area", element) + "\n";

 */

//                            광주 - 운행정보
                            String txt =
                                            getTagValue("start_station_id", element) + "|" +
                                            getTagValue("start_station_name", element) + "|" +
                                            getTagValue("end_station_id", element) + "|" +
                                            getTagValue("end_station_name", element) + "|" +
                                            getTagValue("station_distance", element) + "|" +
                                            getTagValue("station_time", element) + "\n";

//                   txt로 출력하기
                            //FileWriter fw = new FileWriter("C:\\Users\\neiandcompany\\Desktop\\incheon_BUS_station2.txt", true);
//                            FileWriter fw = new FileWriter("C:\\Users\\jiwon\\Desktop\\광주 - 기본역정보 2021-04-14.txt", true);
                            FileWriter fw = new FileWriter("C:\\Users\\jiwon\\Desktop\\광주 - 운행정보 2021-04-14.txt", true);
                            fw.write(txt);
                            fw.flush();
                            fw.close();
